...
namespace CRUDTests
{
    public class CountriesServiceTest
    {
        ...
        //When the CountryName is a duplicate, it should throw an ArgumentException
        [Fact]
        ...
        //When you supply the proper country name, it should insert (add) the country to the existing list of countries
        [Fact]
